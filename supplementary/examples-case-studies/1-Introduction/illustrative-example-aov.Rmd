...
mpar <- aov(Perceived_Efficiency ~ Difficulty*Technique + Error(Participant), data=df) # Parametric - no transformation
mart <- art(Perceived_Efficiency ~ Difficulty*Technique + Error(Participant), data=df) # ARTool
mrnk <- aov(rank(Perceived_Efficiency) ~ Difficulty*Technique + Error(Participant), data=df) # Rank transformation 
mint <- aov(int(Perceived_Efficiency) ~ Difficulty*Technique + Error(Participant), data=df) # Inverse Transform transformation
``` 
