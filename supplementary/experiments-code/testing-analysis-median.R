...
printResults <- function(family, res){
  ...
  cat("ART: ", res[grep("ARTmean", names(res))], "\n")
  cat("ART-med: ", res[grep("ARTmedian", names(res))], "\n")
...
cat("\nUse of aov function", "\n")
printResults("Normal: ", compare_p_values_median(df_normal, formula, vars))
printResults("Ordinal: ", compare_p_values_median(df_ordinal, formula, vars))
printResults("Lognormal: ", compare_p_values_median(df_lognormal, formula, vars))
printResults("Exp: ", compare_p_values_median(df_exp, formula, vars))
printResults("Poisson: ", compare_p_values_median(df_poisson, formula, vars))
printResults("Binom: ", compare_p_values_median(df_poisson, formula, vars))
