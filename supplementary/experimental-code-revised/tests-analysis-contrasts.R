# Testing results of contrasts among different methods
...
cat("Using lmer function", "\n")
printResults("Normal: ", compare_p_values_contrasts(df_normal, formula, expr))
printResults("Ordinal: ", compare_p_values_contrasts(df_ordinal, formula, expr))
printResults("Lognormal: ", compare_p_values_contrasts(df_lognormal, formula, expr))
printResults("Exp: ", compare_p_values_contrasts(df_exp, formula, expr))
printResults("Poisson: ", compare_p_values_contrasts(df_poisson, formula, expr))
printResults("Binom: ", compare_p_values_contrasts(df_poisson, formula, expr))
