...
# Experiment evaluating the Type I error rates of PAR, ART, RNK, and INT under various lognormal distributions.
# See Appendix: Fig. 11, Fig. 12, Fig. 13
...
# Lognormal distributions with various sigma parameters
...
filename = "Appendix_test_lognormal"
