...
write.csv(df, file = "example-data-1-simplified.csv", row.names=FALSE, quote=F) # We print the dataset so that other researchers can try it directly
...
# Store the results
filename <- "permutation-example-rates-1.csv"
