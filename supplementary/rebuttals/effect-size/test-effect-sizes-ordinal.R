...
# Experiment evaluating the effect size estimates of PAR, ART, RNK, and INT for an ordinal scale with 5 levels
...
Ns <- c(16, 32, 64, 128, 254) 

# Number of iterations for each effect size
R <- 300

filename = "effects-ordinal" 
