...
# Experiment evaluating the Type I error rates of PAR, ART, RNK, and INT under various binomial distributions.
# See Appendix: Fig. 14, Fig. 15, Fig. 16
