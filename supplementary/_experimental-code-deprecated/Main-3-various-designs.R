...
# C. Continuous distributions (equal variance, full), discrete distribution: binom (size = 10, prob = 0.1) and Poisson, ordinal -- 5 levels with flexible thresholds
