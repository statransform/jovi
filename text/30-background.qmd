...
Notice that even for this very small dataset ($n = 2$), the three ART rankings are distinct from one another, and also markedly different from the ranking produced by a simple rank transformation. Interestingly, identical responses (e.g., the two $0.3$ in our example dataset) may be assigned very different ranks, while responses that differ greatly (e.g., $0.3$ and $3.0$) can be assigned the same rank. Furthermore, ART significantly exaggerates the differences between the two groups $a_1$ and $a_2$ within factor $A$ (as seen in the $ART_A$ ranks).
...
![Citations of the CHI 2011 paper on ARTool [@wobbrock:2011] as shown in Google Scholar on 28 April 2024. We analyzed the 439 citing bibliographic entries of 2023 in more detail.](images/ARTool-citations-28-april-2024.png){width=80% #fig-ARTool-citations}
