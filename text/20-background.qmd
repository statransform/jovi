...
Our goal is to verify Lüpsen's findings by employing an alternative set of experimental configurations and a distinctly different methodology. While our simulation strategy is similar to that of @elkin:2021, we investigate a larger range of experimental settings and critical scenarios that the authors did not consider, particularly the influence of non-null effects and discrete data. 
