...
```
Positive rates ($\alpha = .05$) for the **main effect of $X_1$** as the ratio of standard deviations $r_{sd}$ for $X_1$ increases ($n=20$). *Note: When $r_{sd} > 1$, the underlying populations are no longer identical, and different interpretations of the null hypothesis may lead to different outcomes.*
:::
